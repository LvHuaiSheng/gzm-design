...
const props = defineProps({
    ...
    plugins: {
        type: [String, Array],
        default: "lists  table codesample code",
    },
    //必填
    toolbar: {
        type: [String, Array],
        default:
            "bold italic underline alignleft aligncenter alignright alignjustify | undo redo | formatselect | fontselect | fontsizeselect | forecolor backcolor fontfamily fontsizeinput | bullist numlist outdent indent | lists link table | removeformat | code codesample",
    },
    menubar: {
        type: [String, Array],
